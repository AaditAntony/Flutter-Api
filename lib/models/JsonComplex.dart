...
JsonComplex jsonComplexFromJson(String str) => JsonComplex.fromJson(json.decode(str));
String jsonComplexToJson(JsonComplex data) => json.encode(data.toJson());
class JsonComplex {
  JsonComplex({
      num? id, 
      String? name, 
  ...
  JsonComplex.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
